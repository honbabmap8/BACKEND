...
VALUES
    (1, '마녀김밥 삼각지점', 1, 1, 117, 37.53372, 126.97218, '마녀 김밥, 묵참 김밥', '분식', 'https://buly.kr/9tD1kVr', NOW()),
    (2, '명화원', 2, 1, 64, 37.53358, 126.97278, '자장면, 짬뽕', '중식', 'https://buly.kr/6te7DBT', NOW()),
    (3, '101번지남산돈까스 삼각지점', 2, 1, 47, 37.53336, 126.97325, '돈까스누들맵떡, 남산치킨까스', '돈까스', 'https://buly.kr/7x8f66W', NOW()),
    (4, '대원식당', 4, 1, 141, 37.53318, 126.97386, '생선구이백반, 두루치기백반', '연탄불 향 가득한 생선구이의 진수', 'https://buly.kr/A47kruM', NOW()),
    (5, '멜팅팟', 3, 1, 162, 37.53292, 126.97172, '전복 내장 파스타, 토마토 꿀 가자미', '퀄리티가 보장된 인생 맛집', 'https://buly.kr/D3gdXoW', NOW()),
    (6, '더수피', 4, 1, 155, 37.53278, 126.97236, '솔티드 카라멜 프렌치토스트, 할라피뇨엔쵸비파스타', '깔끔한 음식과 분위기 좋은 브런치 카페', 'https://buly.kr/90dCz3r', NOW()),
    (7, '맘스터치 삼각지역점', 1, 1, 15, 37.53254, 126.97302, '싸이버거 세트, 빅싸이순살', '햄버거', 'https://image.gsncoupon.com:34443//202311/09/20231109PD1699518473731241.jpg', NOW()),
    (8, '한강버거', 3, 1, 100, 37.53235, 126.97362, '새우버거, 한강 BBQ 버거', '오동통 새우가 씹히는 새우버거의 매력', 'https://buly.kr/5fEqCwR', NOW()),
    (9, '치히로 서울용산점', 2, 1, 254, 37.53212, 126.97412, '에비텐동, 사케동', '바삭한 텐동과 함께하는 행복한 한 끼', 'https://buly.kr/AlmmnGE', NOW()),
    (10, '이아초밥 용산점', 5, 1, 217, 37.53184, 126.97202, '회전초밥, 우동정식', '회전초밥으로 만나는 신선한 맛', 'https://buly.kr/GvpJ7pL', NOW()),
    (11, '스시투고', 5, 1, 99, 37.53172, 126.97268, '모듬초밥, 불초밥+미니우동', '불향 가득 입힌 인기 초밥의 매력', 'https://buly.kr/883Q53Y', NOW()),
    (12, '마토미', 5, 1, 190, 37.53155, 126.97328, '수아데로 타코, 트리파스 타코', '곱창타코로 느끼는 멕시코의 진한 맛', 'https://buly.kr/AwhZdQ7', NOW()),
    (13, '부국정', 3, 1, 110, 37.53138, 126.97386, '양곰탕, 한우육회비빔밥', '진한 국물의 해장국이 인기인 삼각지 대표 맛집', 'https://buly.kr/1GLrpGK', NOW()),
    (14, '덕순이감자탕', 4, 1, 118, 37.53392, 126.97156, '뼈해장국, 우거지감자탕', '깔끔한 국물맛의 묵은지감자탕', 'https://buly.kr/G3FY55C', NOW()),
    (15, '골목식당', 3, 1, 119, 37.53218, 126.97142, '순두부찌개, 청국장', '요일별 정식 맛집', 'https://buly.kr/B7cIkyU', NOW());
