...
VALUES
    (1, '마녀김밥 삼각지점', 1, 1, 117, 37.536394, 126.972577, '마녀 김밥, 묵참 김밥', '분식', 'https://buly.kr/6Bz27zl', NOW()),
    ...
    (7, '맘스터치 삼각지역점', 1, 1, 15, 37.536254, 126.973284, '싸이버거 세트, 빅싸이순살', '햄버거', 'https://buly.kr/GkuY8yB', NOW()),
    (8, '한강버거', 3, 1, 100, 37.53484, 126.974897, '새우버거, 한강 BBQ 버거', '오동통 새우가 씹히는 새우버거의 매력', 'https://buly.kr/15R6qNU', NOW()),
    ...
    (12, '마토미', 5, 1, 190, 37.537453, 126.974355, '수아데로 타코, 트리파스 타코', '곱창타코로 느끼는 멕시코의 진한 맛', 'https://buly.kr/8piS0KZ', NOW()),
    (13, '부국정', 3, 1, 110, 37.534624, 126.974317, '양곰탕, 한우육회비빔밥', '진한 국물의 해장국이 인기인 삼각지 대표 맛집', 'https://buly.kr/1GLrpGK', NOW()),
    (14, '덕순이감자탕', 4, 1, 118, 37.534137, 126.973893, '뼈해장국, 우거지감자탕', '깔끔한 국물맛의 묵은지감자탕', 'https://buly.kr/Chr7aIu', NOW()),
    (15, '골목식당', 3, 1, 119, 37.534482, 126.974356, '순두부찌개, 청국장', '요일별 정식 맛집', 'https://buly.kr/6Bz27zl', NOW());
