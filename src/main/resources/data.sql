...
VALUES
    ...
    (3, '101번지남산돈까스 삼각지점', 2, 1, 47, 37.535591, 126.975520, '돈까스누들맵떡, 남산치킨까스', '돈까스', 'https://buly.kr/7x8f66W', NOW()),
    (4, '대원식당', 4, 1, 141, 37.534845, 126.974913, '생선구이백반, 두루치기백반', '연탄불 향 가득한 생선구이의 진수', 'https://buly.kr/A47kruM', NOW()),
    (5, '멜팅팟', 3, 1, 162, 37.535022, 126.974350, '전복 내장 파스타, 토마토 꿀 가자미', '퀄리티가 보장된 인생 맛집', 'https://buly.kr/D3gdXoW', NOW()),
    (6, '더수피', 4, 1, 155, 37.536229, 126.971754, '솔티드 카라멜 프렌치토스트, 할라피뇨엔쵸비파스타', '깔끔한 음식과 분위기 좋은 브런치 카페', 'https://buly.kr/90dCz3r', NOW()),
    (7, '맘스터치 삼각지역점', 1, 1, 15, 37.537071, 126.974370, '싸이버거 세트, 빅싸이순살', '햄버거', 'https://buly.kr/GkuY8yB', NOW()),
    (8, '한강버거', 3, 1, 100, 37.535071, 126.975470, '새우버거, 한강 BBQ 버거', '오동통 새우가 씹히는 새우버거의 매력', 'https://buly.kr/15R6qNU', NOW()),
    (9, '치히로 서울용산점', 2, 1, 254, 37.533080, 126.973394, '에비텐동, 사케동', '바삭한 텐동과 함께하는 행복한 한 끼', 'https://buly.kr/AlmmnGE', NOW()),
    (10, '이아초밥 용산점', 5, 1, 217, 37.531796, 126.972203, '회전초밥, 우동정식', '회전초밥으로 만나는 신선한 맛', 'https://buly.kr/GvpJ7pL', NOW()),
    (11, '스시투고', 5, 1, 99, 37.536376, 126.972653, '모듬초밥, 불초밥+미니우동', '불향 가득 입힌 인기 초밥의 매력', 'https://buly.kr/883Q53Y', NOW()),
    (12, '마토미', 5, 1, 190, 37.537501, 126.974349, '수아데로 타코, 트리파스 타코', '곱창타코로 느끼는 멕시코의 진한 맛', 'https://buly.kr/8piS0KZ', NOW()),
    ...
    (15, '골목식당', 3, 1, 119, 37.534520, 126.974341, '순두부찌개, 청국장', '요일별 정식 맛집', 'https://buly.kr/6Bz27zl', NOW());
